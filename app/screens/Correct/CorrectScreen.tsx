...
import styles from "./CorrectScreen.styles";
import navigationOptions from "./CorrectScreen.navigationOptions";

const CorrectScreen: NavStatelessComponent = () => {
    ...
    <View style={styles.background}>
      <View style={styles.containerBack}>
        ...
        <View style={styles.footer}>
          <Text style={{color:Colors.white, fontSize:18, fontWeight:"bold",marginBottom:20}}>{"Great job"}</Text>
          <TouchableOpacity onPress={()=>continuePlay()}>
            <Text style={[styles.button,{backgroundColor:Colors.white,color:Colors.whiteblue}]}>{"Continue"}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
...
CorrectScreen.navigationOptions = navigationOptions();
